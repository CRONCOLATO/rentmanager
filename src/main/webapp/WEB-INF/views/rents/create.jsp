                        ...
                        <form class="form-horizontal" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="debut" name="debut" placeholder="Début de reservation">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="fin" class="col-sm-2 control-label">Date de fin</label>
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="fin" name="fin" placeholder="Fin de reservation">
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
