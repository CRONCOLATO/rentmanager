                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <h3 class="profile-username text-center">${client.prenom} ${client.nom} ${client.email} ${client.naissance}</h3>
                            ...
                            <ul class="list-group list-group-unbordered">
                                ...
                                <li class="list-group-item">
                                    <b>Voiture(s)</b> <a class="pull-right">${clientVehicles.size()}</a>
                                </li>
                            </ul>
                        </div>
                        <!-- /.box-body -->
                            ...
                            <div class="tab-pane" id="cars">
                                ...
                                <div class="box-body no-padding">
                                    <table class="table table-striped">
                                        ...
                                        <c:forEach items="${clientVehicles}" var="vehicle">
                                        <tr>
                                            <td>${vehicle.id}.</td>
                                            <td>${vehicle.model}</td>
